        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
          ...
          {step === 2 && (
            <>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="flex flex-col">
                    ...
                    <FormDescription>
                      Select a single date or a date range for your project.
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-base">Where will it take place?</FormLabel>
                    <FormControl>
          ...
          {step === 3 && (
            <>
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      Please provide between 250-500 characters.
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={() => (
                  <FormItem>
                    <FormLabel className="text-base">Add any inspiration or references (optional)</FormLabel>
                    <FormControl>
                      <Input type="file" multiple accept="image/*" className="mt-2" />
                    </FormControl>
                    <FormDescription>
                      Drag and drop up to 3 files.
                    </FormDescription>
                  </FormItem>
                )}
              />
          ...
          {step === 4 && (
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel className="text-base">How did you hear about me?</FormLabel>
                  <Select onValueChange={field.onChange} defaultValue={field.value}>
                    <FormControl>
                      <SelectTrigger className="mt-2">
...
>>>>>>> 2fa6910056d868d92e1d459b9ae948bd5d308620
